...
<task type="checkpoint:human-action" gate="blocking">
  <action>Update Kapso webhook URL to production</action>
  <instructions>
1. Go to Kapso dashboard: https://app.kapso.ai/projects/2bdca4dd-e230-4a1a-8639-68f8595defa8
2. Navigate to Settings > Webhooks (or wherever webhook URL is configured)
3. Update webhook URL from old URL to: `https://my21staff.vercel.app/api/webhook/kapso`
4. Save the webhook configuration
5. Note: This ensures inbound WhatsApp messages are sent to the new production site
  </instructions>
  <resume-signal>Type "webhook updated" when URL is changed in Kapso</resume-signal>
</task>
...
<verification>
- [ ] Kapso webhook URL updated to production (my21staff.vercel.app)
