...
must_haves:
  truths:
    - "All ARI data exists in Convex with correct record counts"
    - "All CMS data exists in Convex with correct workspace mapping"
    - "Workspace and contact ID mappings are valid in migrated data"
    - "Migration report shows 100% transfer success (or 0 records for unused tables)"
  artifacts:
