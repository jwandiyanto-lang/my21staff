...
Output:
- Workflow rules engine with configurable rules
...
<task type="auto">
  <name>Task 1: Create workflow type definitions</name>
...
<task type="auto">
  <name>Task 2: Create keyword trigger matching logic</name>
...
<task type="auto">
  <name>Task 3: Create main rules engine orchestrator</name>
...
- Lead type detection uses conversation history
...
2. Rules engine exports are accessible: `grep -l "processWithRules" src/lib/workflow/*.ts`
3. Type definitions are complete: `grep -l "WorkflowConfig" src/lib/workflow/*.ts`
</verification>
