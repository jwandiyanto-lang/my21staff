...
must_haves:
  truths:
    ...
    - "Keyword triggers for manager bot are detected and logged"
...
for (const messageData of newMessages) {
  ...
  try {
    ...
    if (rulesResult.handled && rulesResult.response) {
      ...
      // If manager bot triggered, queue for Grok processing
...
Run: `npm run lint` to check for linting issues.
  ...
  <done>Webhook handler calls rules engine before AI processor, logs executions, and handles rule-matched responses.</done>
</task>
