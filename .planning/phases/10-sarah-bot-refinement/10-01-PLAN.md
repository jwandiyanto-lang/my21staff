...
- Validation rules section exists with format requirements for each slot
...
4. **Update check-keywords function (optional but recommended):**
   - Update handoff keywords to match Sarah-Training.md:
...
6. **Test immediately:**
  ...
  <resume-signal>
Type "tested" when you've completed the update.

**REQUIRED:** Paste Sarah's actual response to your test message.

**Verification checklist (all must pass):**
1. Response uses "kamu" pronoun (not "kakak" or "Anda")
2. Response contains NO emojis
3. Response is under 140 characters
4. Sarah asks for name first (e.g., "Boleh tau nama kamu?")

Example valid response:
"Halo. Saya Sarah, Staff Digital my21staff. Gimana kabarnya?"
(Then: "Boleh tau nama kamu?")

If response fails any check, describe what's wrong and re-update the prompt.
  </resume-signal>
</task>
