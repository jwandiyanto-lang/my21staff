...
user_setup:
  - service: kapso-dashboard
    ...
    dashboard_config:
      ...
      - task: "Update handoff keywords in check-keywords function"
...
## Quick Reference
[Slot order, key phrases, handoff triggers]
...
6. **Test immediately:**
  ...
  <resume-signal>
Type "tested" when you've updated the workflow and verified Sarah responds correctly.
Include what response you got from Sarah.
  </resume-signal>
</task>
