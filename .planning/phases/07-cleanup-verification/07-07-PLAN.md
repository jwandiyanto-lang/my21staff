...
- grep for "@/lib/supabase" in src/ returns nothing
  </verify>
  <done>
...
<task type="checkpoint:human-action" gate="blocking">
  <action>Remove Supabase environment variables from Vercel</action>
  <instructions>
...
This can be done after merge, but note it in the summary.
  </instructions>
  <resume-signal>Type "done" when env vars handled (or "later" to defer)</resume-signal>
</task>
...
6. Vercel env vars handled (removed or prefixed)
</success_criteria>
