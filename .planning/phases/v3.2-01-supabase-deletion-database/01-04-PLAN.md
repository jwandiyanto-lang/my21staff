...
must_haves:
  truths:
    - "All Google Sheets leads appear in Contact Database"
...
**Questions to answer:**
- How many contacts are in the database now?
- How many leads are in Google Sheets?
...
- User confirms Google Sheets leads are syncing
