...
number: 1
name: Avatar Color Stability
expected: |
  In Database view, click a contact to open detail sheet.
  Edit the contact's name and save.
  The avatar color should NOT change after the name is updated.
