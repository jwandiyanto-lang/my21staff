...
<task type="auto">
  ...
  <action>
    ...
    2. If NEXT_PUBLIC_DEV_MODE is missing or wrong, set it:
       - `vercel env add NEXT_PUBLIC_DEV_MODE` -> enter "false" -> select Production
...
- Production environment has DEV_MODE=false
</success_criteria>
