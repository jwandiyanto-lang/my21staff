...
**Status:** Complete (6/7 fixes, 1 deferred)
**Duration:** ~15 min
...
7. **Assigned to dropdown** - Requires fetching workspace_members in inbox page and passing to client. The `assigned_to` column already exists in conversations table. This is a feature enhancement for a future phase.
