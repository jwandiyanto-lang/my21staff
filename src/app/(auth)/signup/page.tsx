            ...
            >
              ...
              <div className="p-8 pt-12">
                ...
                <button
                  ...
                  className="w-full py-3.5 px-4 rounded-xl bg-white/50 border border-gray-200/50 text-gray-700 font-semibold hover:bg-white/70 focus:outline-none focus:ring-2 focus:ring-[#2D4B3E]/30 transition-all"
                >
                  Back to login
                </button>
              </div>
          ...
          >
            ...
            <div className="p-8 pt-12">
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">
                  Join my21staff to manage your business
                </p>
              </div>
