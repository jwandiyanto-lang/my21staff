...
// =============================================================================
// MOCK BRAIN ANALYTICS DATA (Phase 6 - Dashboard)
// Used by insights page for AI-generated summaries, actions, and patterns
// =============================================================================

/**
 * Mock Brain daily summary
 * Generated by Grok to provide conversational daily insights
 */
export const MOCK_BRAIN_SUMMARY = {
  ...
  created_at: Date.now() - 8 * 60 * 60 * 1000, // 8 hours ago (morning summary at 09:00 WIB)
  metrics: {
    newLeadsCount: 5,
    hotLeadsCount: 2,
    warmLeadsCount: 8,
...
/**
 * Mock Brain action recommendations
 * Prioritized follow-up suggestions with personalized WhatsApp templates
 */
export const MOCK_BRAIN_ACTIONS = [
  {
    _id: 'action-001',
    workspace_id: 'demo',
    contact_id: 'lead-001', // Budi Santoso
    action_type: 'follow_up' as const,
    priority: 92,
    urgency: 'immediate' as const,
    reason: 'Hot lead dengan budget terkonfirmasi, belum di-follow up 3 hari',
    suggested_message: 'Halo Pak Budi! Terima kasih sudah berbagi detail bisnis restoran Anda. Saya ingin membahas solusi yang cocok untuk kebutuhan tim 15 orang. Kapan waktu yang nyaman untuk ngobrol lebih lanjut?',
    status: 'pending' as const,
    created_at: Date.now() - 2 * 60 * 60 * 1000,
    expires_at: Date.now() + 22 * 60 * 60 * 1000, // Expires in 22 hours
  },
  {
    _id: 'action-002',
    workspace_id: 'demo',
    contact_id: 'lead-002', // Siti Rahayu
    action_type: 'follow_up' as const,
    priority: 78,
    urgency: 'today' as const,
    reason: 'Warm lead, no response for 2 days - butuh booking system WhatsApp',
    suggested_message: 'Halo Bu Siti! Gimana kabarnya? Saya ada update tentang integrasi booking dengan WhatsApp yang kemarin kita obrolin. Mau saya share detail lengkapnya?',
    status: 'pending' as const,
    created_at: Date.now() - 3 * 60 * 60 * 1000,
    expires_at: Date.now() + 21 * 60 * 60 * 1000,
  },
  {
    _id: 'action-003',
    workspace_id: 'demo',
    contact_id: 'lead-006', // Rina Wijaya (Gym)
    action_type: 'opportunity_alert' as const,
    priority: 68,
    urgency: 'this_week' as const,
    reason: 'Mentioned expanding team - potential upsell opportunity',
    suggested_message: 'Halo Bu Rina! Congrats untuk expansion gym nya! Kalau butuh bantuan manage tim yang lebih besar, my21staff bisa sangat membantu. Mau diskusi?',
    status: 'pending' as const,
    created_at: Date.now() - 4 * 60 * 60 * 1000,
    expires_at: Date.now() + 20 * 60 * 60 * 1000,
  },
  {
    _id: 'action-004',
    workspace_id: 'demo',
    contact_id: 'lead-007', // Bambang Sugiarto (Auto Repair)
    action_type: 'follow_up' as const,
    priority: 81,
    urgency: 'immediate' as const,
    reason: 'Hot lead, last active 1 hour ago - momentum tinggi',
    suggested_message: 'Halo Pak Bambang! Saya lihat Bapak baru cek info kita. Ada pertanyaan yang bisa saya bantu? Senang bisa ngobrol lebih lanjut!',
    status: 'pending' as const,
  ...
  },
  {
    _id: 'action-005',
    workspace_id: 'demo',
    contact_id: 'lead-009', // Joko Widodo (Furniture)
    action_type: 'follow_up' as const,
    priority: 72,
    urgency: 'today' as const,
    reason: 'Warm lead, mentioned delivery tracking needs',
    status: 'pending' as const,
...
/**
 * Mock Brain conversation pattern insights
 * Detects trending topics, objections, signals from lead conversations
 */
export const MOCK_BRAIN_INSIGHTS = [
  {
    _id: 'insight-001',
    workspace_id: 'demo',
    insight_type: 'trending_topic' as const,
    pattern: 'Employee scheduling',
    frequency: 8,
    confidence: 'high' as const,
    examples: [
      'Susah atur jadwal karyawan',
      'Shift management ribet banget',
      'Butuh sistem jadwal yang otomatis',
      'Karyawan sering bentrok jadwal',
    ],
    suggested_faqs: [
      {
        question: 'Bagaimana cara atur jadwal shift karyawan?',
        suggested_answer: 'Dengan my21staff, Anda bisa atur jadwal shift dengan drag-and-drop interface yang mudah digunakan. Sistem otomatis deteksi konflik jadwal dan kirim notifikasi ke karyawan via WhatsApp.',
      },
      {
        question: 'Apakah bisa auto-reminder untuk shift?',
        suggested_answer: 'Ya! my21staff otomatis kirim reminder H-1 dan 2 jam sebelum shift via WhatsApp. Karyawan juga bisa konfirmasi kehadiran langsung dari chat.',
      },
    ],
    time_range: 'week',
  ...
  },
  {
    _id: 'insight-002',
    workspace_id: 'demo',
    insight_type: 'objection_pattern' as const,
    pattern: 'Harga terlalu mahal',
    frequency: 5,
    confidence: 'medium' as const,
    examples: [
      'Budget terbatas',
      'Masih mikir-mikir harganya',
      'Kompetitor lebih murah',
      'Untuk bisnis kecil seperti saya kok mahal',
    ],
    suggested_faqs: [
      {
        question: 'Kenapa harganya lebih mahal dari kompetitor?',
        suggested_answer: 'my21staff bukan hanya software, tapi complete solution dengan AI assistant (Sarah) yang handle customer inquiry 24/7. Hemat biaya hire CS, dan include WhatsApp integration yang seamless.',
      },
    ],
    time_range: 'week',
  ...
  },
  {
    _id: 'insight-003',
    workspace_id: 'demo',
    insight_type: 'interest_signal' as const,
    pattern: 'WhatsApp integration',
    frequency: 12,
    confidence: 'high' as const,
    examples: [
      'Bisa integrasi dengan WhatsApp?',
      'Customer saya semua pakai WA',
      'Butuh notifikasi via WhatsApp',
      'Chat langsung dari WA bisa?',
    ],
    suggested_faqs: [
      {
        question: 'Bagaimana cara WhatsApp integration bekerja?',
        suggested_answer: 'my21staff fully integrated dengan WhatsApp Business API. Semua notifikasi, booking confirmation, dan customer chat langsung via WhatsApp. Sarah (AI assistant) handle pertanyaan customer otomatis.',
      },
    ],
    time_range: 'week',
    created_at: Date.now() - 18 * 60 * 60 * 1000,
  },
  {
    _id: 'insight-004',
    workspace_id: 'demo',
    insight_type: 'rejection_reason' as const,
    pattern: 'Sudah punya sistem sendiri',
    frequency: 4,
    confidence: 'medium' as const,
    examples: [
      'Sudah pakai Excel',
      'Ada spreadsheet sendiri',
      'Sudah ada sistem manual',
    ],
    time_range: 'week',
...
/**
 * Mock lead statistics for quality overview
 * Aggregated data about lead distribution and scoring
 */
