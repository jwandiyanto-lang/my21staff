...
@planning/phases/03-ai-system/03-02-SUMMARY.md
@planning/phases/03-ai-system/03-03-SUMMARY.md
@convex/kapso.ts
@convex/ai/mouth.ts
@convex/ai/brain.ts
</context>
...
if (mouthResponse.model !== "fallback") {
  await ctx.db.insert("aiUsage", {
    ...
    conversation_id: (ariConversation as any)._id,
...
ctx.scheduler.runAfter(1000, internal.ai.brain.analyzeConversation, {
  ...
  ariConversationId: (ariConversation as any)._id,
  recentMessages: [
